...
// --- Statische Game Data ---
// We gebruiken deze data om de app 100% stabiel en snel te maken.
// De connectie met de live Roblox API bouwen we later terug in op een betere manier.
const mockGames = [
    ...
    { id: '1537690962', title: 'Brookhaven RP', developerId: 'dev2', developer: 'Wolfpaq', genre: 'RPG', icon: 'https://placehold.co/150/16A34A/FFFFFF?text=B', description: 'Een plek om rond te hangen met gelijkgestemde mensen. Wees wie je wilt zijn in Brookhaven.', visits: 25_000_000_000, players: 450000 },
    { id: '2753915549', title: 'Tower of Hell', developerId: 'dev3', developer: 'YXCeptional Studios', genre: 'Obby', icon: 'https://placehold.co/150/DC2626/FFFFFF?text=T', description: 'Kun jij deze willekeurig gegenereerde toren beklimmen? Geen checkpoints. Pure vaardigheid.', visits: 18_000_000_000, players: 80000 },
    { id: '6284583030', title: 'Blox Fruits', developerId: 'dev4', developer: 'gamer robot inc.', genre: 'Adventure', icon: 'https://placehold.co/150/3B82F6/FFFFFF?text=F', description: 'Word een meesterzwaardvechter of een krachtige Blox Fruit-gebruiker terwijl je traint om de sterkste speler ooit te worden.', visits: 15_000_000_000, players: 500000 },
    { id: '7795794352', title: 'Pet Simulator X', developerId: 'dev5', developer: 'BIG Games Pets', genre: 'Simulator', icon: 'https://placehold.co/150/F97316/FFFFFF?text=P', description: 'Verzamel eieren, laat huisdieren uitkomen en ontgrendel nieuwe werelden! Honderden huisdieren om te verzamelen.', visits: 10_000_000_000, players: 120000 },
    { id: '8737602449', title: 'DOORS', developerId: 'dev6', developer: 'LSPLASH', genre: 'Horror', icon: 'https://placehold.co/150/1F2937/FFFFFF?text=D', description: 'Een unieke horrorervaring met procedureel gegenereerde levels. Elke deur is een nieuwe verrassing.', visits: 5_000_000_000, players: 75000 },
    { id: '2414851778', title: 'Murder Mystery 2', developerId: 'dev7', developer: 'Nikilis', genre: 'Murder Mystery', icon: 'https://placehold.co/150/F59E0B/FFFFFF?text=M', description: 'Los het mysterie op! Een onschuldige is de moordenaar, kun je overleven en de schutter ontmaskeren?', visits: 9_000_000_000, players: 65000 },
];

const mockDevelopers = { 'dev1': { name: 'Uplift Games', isVerified: true }, 'dev2': { name: 'Wolfpaq', isVerified: false }, 'dev3': { name: 'YXCeptional Studios', isVerified: true }, 'dev4': { name: 'gamer robot inc.', isVerified: false }, 'dev5': { name: 'BIG Games Pets', isVerified: true }, 'dev6': { name: 'LSPLASH', isVerified: true }, 'dev7': { name: 'Nikilis', isVerified: false }};
...
export default function App() {
    ...
    useEffect(() => {
        ...
        const unsubscribeAuth = onAuthStateChanged(auth, (currentUser) => {
            if (unsubscribeUser) unsubscribeUser(); // Stop de vorige profiel listener
