...
// GECORRIGEERD: GameList met correcte data parsing via CORS proxy
    ...
    const fetchGames = async (term = '') => {
        ...
        try {
            ...
            const enrichedGames = initialGames.map(game => {
                const thumbnail = thumbnails.find(t => t.targetId === game.universeId);
                return {
                    id: game.universeId,
